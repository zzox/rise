...
export default class HUD {
    ...
    this.graphics().map(item => {
		...
		this.playerHealthText = this.scene.add.bitmapText(8, 10, 'font', `Health:${this.scene.player.health}`)
			.setScrollFactor(0, 0)
		...
		this.playerAmmoText = this.scene.add.bitmapText(200, 10, 'font', `Ammo:${this.scene.player.ammo}`)
			.setScrollFactor(0, 0)
	...
	update () {
		// player health
		// console.log(this.scene.player.health + ' ' + this.playerHealth)
